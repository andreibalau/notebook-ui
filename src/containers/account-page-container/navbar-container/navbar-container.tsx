...
import Menu, { MenuMediaTypeScreenIcons } from "../../../components/account-page-components/navbar-components/menu/menu";
...
class NavBarContainer extends React.Component<NavBarProps, NavBarState> {
  ...
  private readonly mediaTypeIconItems:MenuMediaTypeScreenIcons = {
    ...
    return (
      <div className="navigationBarElementsWrapper">
        ...
        <div className="menuListNavBar">
          <div id="menuList">
            <Menu items={menuItemList} mediaTypeItemsIcons={this.mediaTypeIconItems}/>
          </div>
        </div>
